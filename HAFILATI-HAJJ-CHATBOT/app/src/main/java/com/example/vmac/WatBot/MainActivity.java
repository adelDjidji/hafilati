...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendMessage() {
        ...
        service.setUsernameAndPassword("38e01d53-98cb-493e-b3a8-2510e8943da0", "GNiJJuOnegub");
        InputData input = new InputData.Builder(inputmessage).build();
        MessageOptions options = new MessageOptions.Builder("69362729-c0f3-4bfe-badd-7d48d58a8d44").input(input).context(context).build();
